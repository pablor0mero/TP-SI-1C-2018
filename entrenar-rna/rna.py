...
class NeuralNetwork(object):
    def __init__(self):
        self.input_neuron_count = 784 # 784 neuronas, 1 para cada pixel para imagenes de 28x28 = 784
        self.hidden_neuron_count = 100 # Arbitrario.
        self.output_neuron_count = 10 # Una para cada digito del 0 al 9
        self.learning_rate = 0.1 # Arbitrario.
